...
// endregion SHARED SCOPE

// region ABSTRACT STRUCTURAL SCOPES
/**
 * These scopes are for defining the hierarchical structure of the
 * document scope normally start with 'meta' and are not typically
 * styled directly.
 */

/**
 * document-root (META_DOCUMENT)
 * ├── file-header (META_HEADER)
 * │   ├── ......
 * └── outline
 *     ├── outline-level-1 (META_OUTLINE_1)
 *     │   ├── outline-level-[2,6+] (META_OUTLINE_[2,MORE_THAN_6] + META_OUTLINE_INACTIVE if inactive)
 *     │   │   ├── outline-level-[3,6+] (META_OUTLINE_[2,MORE_THAN_6 + META_OUTLINE_INACTIVE if inactive)
 *     │   │   │   ├── ......
 *     │   │   ├── headline-block (in begin rule)
 *     │   │   └── section-content
 *     │   ├── headline-block (in begin rule)
 *     │   └── section-content (META_SECTION)
 *     │       ├── line-comments
 *     │       ├── blocks
 *     │       ├── keyword-like-lines (META_DIRECTIVE)
 *     │       ├── lists
 *     │       └── paragraph (META_PARAGRAPH, MARKUP_PARAGRAPH)
 *     ├── outline-level-2
 *     │   └── ......
 *     │   ......
 *     └── outline-level-more-than-6
 *         └── ......
 */
...
export const META_OUTLINE_INACTIVE = "comment.block.outline.org";

/** The content of a section, between headlines. */
export const META_SECTION = "meta.section.org";

/** Any block element (begin-end, drawer, table, etc.). */
...
/** Paragraph inside section, divide by empty line */
export const META_PARAGRAPH = "meta.paragraph.org";
export const MARKUP_PARAGRAPH = "markup.paragraph.org";
// endregion ABSTRACT STRUCTURAL SCOPES
...
export const HEADING_LEVEL_1_COMPATIBLE = "markup.bold.heading.1.fallback.org";
export const HEADING_LEVEL_2 = "markup.heading.2.org";
export const HEADING_LEVEL_2_COMPATIBLE = "markup.bold.heading.2.fallback.org";
export const HEADING_LEVEL_3 = "markup.heading.3.org";
export const HEADING_LEVEL_3_COMPATIBLE = "markup.bold.heading.3.fallback.org";
export const HEADING_LEVEL_4 = "markup.heading.4.org";
export const HEADING_LEVEL_4_COMPATIBLE = "markup.bold.heading.4.fallback.org";
export const HEADING_LEVEL_5 = "markup.heading.5.org";
export const HEADING_LEVEL_5_COMPATIBLE = "markup.bold.heading.5.fallback.org";
export const HEADING_LEVEL_6 = "markup.heading.6.org";
export const HEADING_LEVEL_6_COMPATIBLE = "markup.bold.heading.6.fallback.org";
export const HEADING_LEVEL_MORE_THAN_6 = "markup.heading.more-than-6.org";
export const HEADING_LEVEL_MORE_THAN_6_COMPATIBLE = "markup.bold.heading.more-than-6.fallback.org";
...
/**
 * There are also two types of block level comments. one is commented headline
 * and the other is a block comment.
 *
 * the definition related to the block comment are located under block definition.
 */
// endregion Comments
...
// endregion Generic Block Parts

// region block comment
/** A block-level comment, e.g. #+BEGIN_COMMENT ... #+END_COMMENT */
export const META_COMMENT_BLOCK = "meta.block.begin-end.comment.org";

export const COMMENT_BLOCK = "comment.block.org";
...
// endregion Begin-End Blocks

// region Block / Latex
export const META_BLOCK_LATEX = "meta.block.latex.org";
// endregion Block / Latex

// region Block / Drawers
// =================================================================
...
export const TABLE_ROW_SEPARATOR =
  "punctuation.definition.table.row-separator.org";
...
// endregion Planning Line

// region Link Abbreviation
...
// endregion Link Abbreviation

// region Macro
// see MACRO_NAME and MACRO_PARAMETER
// endregion Macro
// endregion Keyword-Like Lines
...
export const STRIKE_THROUGH_PUNCTUATION =
  "punctuation.definition.strikethrough.org";
