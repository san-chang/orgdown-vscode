...
- *Separation of Concerns*: Structural tests are independent of TextMate grammar tests. They test different layers of the architecture (see [[../docs/architecture_decisions/008-tree-sitter-integration.org][ADR-008]]).
